...
// mockPlayers creates 12 test players with skill (1-10) and fitness (1-3) ratings.
func mockPlayers() []balancer.Player {
	return []balancer.Player{
		{ID: 1, Name: "Player1", SkillRating: 8.0, FitnessRating: 3.0},  // Good
		{ID: 2, Name: "Player2", SkillRating: 7.5, FitnessRating: 2.0},  // Normal
		{ID: 3, Name: "Player3", SkillRating: 6.0, FitnessRating: 1.0},  // Poor
		{ID: 4, Name: "Player4", SkillRating: 9.0, FitnessRating: 2.0},  // Normal
		{ID: 5, Name: "Player5", SkillRating: 5.5, FitnessRating: 3.0},  // Good
		{ID: 6, Name: "Player6", SkillRating: 7.0, FitnessRating: 2.0},  // Normal
		{ID: 7, Name: "Player7", SkillRating: 8.5, FitnessRating: 1.0},  // Poor
		{ID: 8, Name: "Player8", SkillRating: 6.5, FitnessRating: 3.0},  // Good
		{ID: 9, Name: "Player9", SkillRating: 7.0, FitnessRating: 2.0},  // Normal
		{ID: 10, Name: "Player10", SkillRating: 5.0, FitnessRating: 2.0}, // Normal
		{ID: 11, Name: "Player11", SkillRating: 8.0, FitnessRating: 3.0}, // Good
		{ID: 12, Name: "Player12", SkillRating: 6.0, FitnessRating: 2.0}, // Normal
	}
}
